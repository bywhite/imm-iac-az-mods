# This module creates the following az pools:
...
resource "intersight_macpool_pool" "macpool_pool1" {
  ...
  dynamic mac_blocks {
    ...
    content {
      from = "00:25:B5:${var.az_id}:${mac_blocks.value}0:01"
      size          = "1000"
    } 
  }
  organization {
...
resource "intersight_fcpool_pool" "wwnnpool_pool1" {
  ...
  dynamic id_blocks {
    for_each = formatlist("%X", range(0,10))
    content {
      from  = "20:00:25:B5:${var.az_id}:${id_blocks.value}0:00:01"
...
resource "intersight_fcpool_pool" "wwpnpool_poolA" {
  ...
  dynamic id_blocks {
    for_each = formatlist("%X", range(0,10))
    content {
      from  = "20:00:25:B5:${var.az_id}:${id_blocks.value}A:00:01"
...
resource "intersight_fcpool_pool" "wwpnpool_poolB" {
  ...
  dynamic id_blocks {
    for_each = formatlist("%X", range(0,10))
    content {
      from  = "20:00:25:B5:${var.az_id}:${id_blocks.value}B:00:01"
...
resource "intersight_uuidpool_pool" "uuidpool_pool1" {
  ...
  dynamic uuid_suffix_blocks {
    ...
    content {
      from  = "${var.az_id}0${uuid_suffix_blocks.value}-000000000000"
